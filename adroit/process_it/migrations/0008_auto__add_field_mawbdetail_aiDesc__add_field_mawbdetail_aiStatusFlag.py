...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MawbDetail.aiDesc'
        db.add_column('process_it_mawbdetail', 'aiDesc',
    ...
    def backwards(self, orm):
        # Deleting field 'MawbDetail.aiDesc'
        db.delete_column('process_it_mawbdetail', 'aiDesc')
    ...
    models = {
        ...
        'process_it.mawbdetail': {
            ...
            'aiStatusFlag': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
