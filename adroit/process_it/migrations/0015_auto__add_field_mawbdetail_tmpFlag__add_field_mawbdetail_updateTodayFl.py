...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MawbDetail.tmpFlag'
        db.add_column('process_it_mawbdetail', 'tmpFlag',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MawbDetail.updateTodayFlag'
        db.add_column('process_it_mawbdetail', 'updateTodayFlag',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MawbDetail.tmpFlag'
        db.delete_column('process_it_mawbdetail', 'tmpFlag')

        # Deleting field 'MawbDetail.updateTodayFlag'
        db.delete_column('process_it_mawbdetail', 'updateTodayFlag')
    ...
    models = {
        ...
        'process_it.mawbdetail': {
            ...
            'aiStatusFlag': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            ...
            'tmpFlag': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
