...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MawbDetail.paLocked'
        db.alter_column('process_it_mawbdetail', 'paLocked', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'MawbDetail.paLocked'
        db.alter_column('process_it_mawbdetail', 'paLocked', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
