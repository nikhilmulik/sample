...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MawbDetail.paLocked'
        db.add_column('process_it_mawbdetail', 'paLocked',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'MawbDetail.paLockedByUser'
        db.add_column('process_it_mawbdetail', 'paLockedByUser',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MawbDetail.paLocked'
        db.delete_column('process_it_mawbdetail', 'paLocked')

        # Deleting field 'MawbDetail.paLockedByUser'
        db.delete_column('process_it_mawbdetail', 'paLockedByUser')
    ...
    models = {
        ...
        'process_it.mawbdetail': {
            ...
            'paLocked': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True'}),
