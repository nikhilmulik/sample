...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'MawbDetail', fields ['station']
        db.create_index('process_it_mawbdetail', ['station'])

        # Adding index on 'MawbDetail', fields ['mawbNum']
        db.create_index('process_it_mawbdetail', ['mawbNum'])


    def backwards(self, orm):
        # Removing index on 'MawbDetail', fields ['mawbNum']
        db.delete_index('process_it_mawbdetail', ['mawbNum'])

        # Removing index on 'MawbDetail', fields ['station']
        db.delete_index('process_it_mawbdetail', ['station'])
    ...
    models = {
        ...
        'process_it.mawbdetail': {
            ...
            'mawbNum': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'db_index': 'True'}),
            ...
            'station': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'db_index': 'True'}),
