...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MawbDetail.lastUpdatedDate'
        db.add_column('process_it_mawbdetail', 'lastUpdatedDate',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MawbDetail.lastUpdatedTime'
        db.add_column('process_it_mawbdetail', 'lastUpdatedTime',
                      self.gf('django.db.models.fields.TimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MawbDetail.lastUpdatedDate'
        db.delete_column('process_it_mawbdetail', 'lastUpdatedDate')

        # Deleting field 'MawbDetail.lastUpdatedTime'
        db.delete_column('process_it_mawbdetail', 'lastUpdatedTime')
