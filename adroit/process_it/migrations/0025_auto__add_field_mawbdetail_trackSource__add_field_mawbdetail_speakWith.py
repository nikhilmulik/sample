...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MawbDetail.trackSource'
        db.add_column('process_it_mawbdetail', 'trackSource',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'MawbDetail.speakWith'
        db.add_column('process_it_mawbdetail', 'speakWith',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MawbDetail.trackSource'
        db.delete_column('process_it_mawbdetail', 'trackSource')

        # Deleting field 'MawbDetail.speakWith'
        db.delete_column('process_it_mawbdetail', 'speakWith')
