...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MawbDetail.itInfo'
        db.add_column('process_it_mawbdetail', 'itInfo',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)


        # Changing field 'MawbDetail.pmcOrLoose'
        db.alter_column('process_it_mawbdetail', 'pmcOrLoose', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

    def backwards(self, orm):
        # Deleting field 'MawbDetail.itInfo'
        db.delete_column('process_it_mawbdetail', 'itInfo')
