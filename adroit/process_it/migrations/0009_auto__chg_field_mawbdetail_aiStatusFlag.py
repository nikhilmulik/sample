...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MawbDetail.aiStatusFlag'
        db.alter_column('process_it_mawbdetail', 'aiStatusFlag', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'MawbDetail.aiStatusFlag'
        db.alter_column('process_it_mawbdetail', 'aiStatusFlag', self.gf('django.db.models.fields.NullBooleanField')(null=True))
