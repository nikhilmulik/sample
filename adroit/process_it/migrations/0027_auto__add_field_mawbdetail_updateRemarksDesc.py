...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MawbDetail.updateRemarksDesc'
        db.add_column('process_it_mawbdetail', 'updateRemarksDesc',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MawbDetail.updateRemarksDesc'
        db.delete_column('process_it_mawbdetail', 'updateRemarksDesc')
