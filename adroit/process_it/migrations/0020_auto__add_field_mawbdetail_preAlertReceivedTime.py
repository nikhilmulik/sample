...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MawbDetail.preAlertReceivedTime'
        db.add_column('process_it_mawbdetail', 'preAlertReceivedTime',
                      self.gf('django.db.models.fields.TimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MawbDetail.preAlertReceivedTime'
        db.delete_column('process_it_mawbdetail', 'preAlertReceivedTime')
