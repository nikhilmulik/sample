...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MawbDetail.parFlag'
        db.delete_column('process_it_mawbdetail', 'parFlag')
    ...
    def backwards(self, orm):
        # Adding field 'MawbDetail.parFlag'
        db.add_column('process_it_mawbdetail', 'parFlag',
